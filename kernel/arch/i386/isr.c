...
*  is present, is running in ring 0 (kernel level), and has 
*  the lower 5 bits set to the required '14', which is 
...
/*
 * All the isr routines call this.
 * For now we just print the exception name and go int an infinite loop.
 */
void fault_handler(struct isr_regs_t *r)
{
	if (r->int_no < 32) {
